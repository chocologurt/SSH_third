...
{
    public partial class CombinedRegister : Page
    {
            ...
            if (user2 == null)
            {
                ...
                if (imagePassword.Visible == true && textPassword.Visible == true)
                {
                    if (imagePasswordControl.HasFile)
                    {
                        ...
                        {
                            ErrorMessage.Text = "Upload Status: Only JPEG and PNG files are available for upload";
                            return;
                        }
                    }
                    else
                ...
                if(userModeSelection.SelectedValue == "1")
                {
                   
                    designation = "Student";
                }
                else if ( userModeSelection.SelectedValue == "2")
                {
                ...
                if (result.Succeeded)
                {
                    ...
                    cmd.Parameters.AddWithValue("@registrationMode", userModeSelection.SelectedValue);
        ...
        protected void userModeSelection_SelectedIndexChanged(object sender, EventArgs e)
        {
            if(userModeSelection.SelectedValue == "2")
            {
                userDesignationDiv.Visible = true;
            }
            else if (userModeSelection.SelectedValue == "1")
            {
                userDesignationDiv.Visible = false;
            }
        }
    }
}