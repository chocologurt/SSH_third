    ...
    <div class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            <asp:Label runat="server" ID="userMode" AssociatedControlID="userModeSelection" CssClass="col-md-2 control-label" TabIndex="0">Do you want to be a Mentee or Mentor</asp:Label>
            <div class="col-md-10">
                <asp:RadioButtonList runat="server" AutoPostBack="true" RepeatDirection="Horizontal" ID="userModeSelection" OnSelectedIndexChanged="userModeSelection_SelectedIndexChanged" >
                    <asp:ListItem Text="Mentee" Value="1"></asp:ListItem>
                    <asp:ListItem Text="Mentor" Value="2"></asp:ListItem>
                </asp:RadioButtonList>
               <asp:RequiredFieldValidator runat="server" ControlToValidate="userModeSelection"
                    CssClass="text-danger" Display="Dynamic" ErrorMessage="Please choose a mode that you want." />
            </div>
        </div>
          <div class="form-group" id="userDesignationDiv" runat="server" visible="false">
            <asp:Label runat="server" AssociatedControlID="userDesignation" CssClass="col-md-2 control-label">Your Designation</asp:Label>
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="userDesignation" CssClass="form-control" TextMode="SingleLine" autocomplete="off" />
                <asp:RequiredFieldValidator runat="server" ControlToValidate="userDesignation"
                 ...
                 <asp:RegularExpressionValidator runat="server" ControlToValidate="userDesignation"
                    ValidationExpression="[A-za-z ]{0,25}"
